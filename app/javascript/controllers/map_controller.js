...
export default class extends Controller {
  ...
  loadMap() {
    ...
    this.map.on("load", () => {
      ...
      this.map.addLayer({
        // individual parking bay markers
      ...
      this.map.on(
        ...
        function (e) {
          ...
          this.map.getSource("parking_bays").getClusterExpansionZoom(
            clusterId,
            function (err, zoom) {
              if (err) return;
  ...
  getIso = (e) => {
    ...
    const lat =
      formData.get("location") === "user"
        ? this.userPosition.latitude
        : this.positionValue.latitude;
    const lon =
      formData.get("location") === "user"
        ? this.userPosition.longitude
        : this.positionValue.longitude;
